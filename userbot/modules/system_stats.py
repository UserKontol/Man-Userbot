...
async def amireallyalive(alive):
    ...
    output = (
        f"**[Adam-Userbot](https://github.com/userkontol/Adam-Userbot) is Up and Running.**\n\n"
        f"**{alive_text}**\n\n"
        ...
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/wibu_telegram** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/adamcodeubot** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={user.id})**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
