...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/adamCodeubot:same> [Support]<buttonurl:https://t.me/wibu_telegram>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/adamCodeubot:same> [Support]<buttonurl:https://t.me/wibu_telegram>`\
    "
    }
)
